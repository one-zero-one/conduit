...
schema "tillless-commerce_0001" do
  ...
  entity "CmsBlock" do
    ...
    string     :content
    integer64  :blockable_id
    string     :blockable_type
    datetime   :created_at
    datetime   :updated_at
  end
  entity "CmsCategory" do
    integer64  :id, default: -1
    integer64  :site_id, null: false
    string     :label, null: false
    string     :categorized_type, null: false
  end
  entity "CmsCategorization" do
    integer64  :id, default: -1
    integer64  :category_id, null: false
    string     :categorized_type, null: false
    integer64  :categorized_id, null: false
  end
  entity "CmsFile" do
    integer64  :id, default: -1
    integer64  :site_id, null: false
    integer64  :block_id
    string     :label, null: false
    string     :file_file_name, null: false
    string     :file_content_type, null: false
    integer64  :file_file_size, null: false
    string     :descrip, limit: 2048
  ...
  entity "CmsLayout" do
    ...
    string     :js
    integer64  :position, default: 0, null: false
    boolean    :is_shared, default: false, null: false
    datetime   :created_at
    datetime   :updated_at
  end
  entity "CmsPage" do
    ...
    integer64  :layout_id
    integer64  :parent_id
    integer64  :target_page_id
    string     :label, null: false
    string     :slug
    string     :full_path, null: false
    string     :content_cache
    integer64  :position, default: 0, null: false
    integer64  :children_count, default: 0, null: false
    boolean    :is_published, default: true, null: false
    boolean    :is_shared, default: false, null: false
    datetime   :created_at
    datetime   :updated_at
  end
  entity "CmsRevision" do
    integer64  :id, default: -1
    string     :record_type, null: false
    integer64  :record_id, null: false
    string     :data
    datetime   :created_at
  end
  entity "CmsSite" do
    ...
    boolean    :is_mirrored, default: false, null: false
  end
  entity "CmsSnippet" do
    integer64  :id, default: -1
    integer64  :site_id, null: false
    string     :label, null: false
    string     :identifier, null: false
